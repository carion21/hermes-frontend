...
const { DEFAULT_PROFILE_ADMIN, stage_NAME, stage_VERSION, stage_DESCRIPTION, ROUTE_ADMIN_OPERATOR_LIST } = require('../../../config/consts');
...
const pagename = "Liste des opérateurs"
...
router.get('/', async function (req, res, next) {
  ...
  let urlcomplete = urlapi + ROUTE_ADMIN_OPERATOR_LIST
