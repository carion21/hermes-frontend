...
const { DEFAULT_PROFILE_ADMIN, stage_NAME, stage_VERSION, stage_DESCRIPTION, ROUTE_ADMIN_APPLICATION_LIST, ROUTE_ADMIN_ADD_OPERATOR } = require('../../../config/consts');
...
const SERVICE_TYPE = "admin_add_operator"

const profile = DEFAULT_PROFILE_ADMIN;
const tabside = getTabSideBase(profile)
const idbloc = 2
const blocname = tabside[idbloc].texte
const pagename = "Ajouter un opérateur"
const template = "add_operator"
...
router.post('/', async function (req, res, next) {
  ...
  if (bcontrol.success) {
    let urlcomplete = urlapi + ROUTE_ADMIN_ADD_OPERATOR
    let xdata = {
