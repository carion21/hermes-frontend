...
const { DEFAULT_PROFILE_ADMIN, stage_NAME, stage_VERSION, stage_DESCRIPTION, ROUTE_ADMIN_ENABLE_APPLICATION, ROUTE_ADMIN_ENABLE_STAGE } = require('../../../config/consts');
...
const SERVICE_TYPE = "admin_enable_stage"
...
router.get('/:stage_id', async function (req, res, next) {
  ...
  if (isInteger(stage_id)) {
    let urlcomplete = urlapi + ROUTE_ADMIN_ENABLE_STAGE
    let xdata = {
      stage_id: stage_id
    }
